...
cap = cv2.VideoCapture("../video/22.mp4")

first_frame = cv2.imread("image/22.png")
first_gray = cv2.cvtColor(first_frame, cv2.COLOR_BGR2GRAY)
first_gray = cv2.GaussianBlur(first_gray, (5, 5), 0)

pts1 = np.array([[100,500],[420,520],[230,720],[140,710]],np.int32)
...
while True:
    ...
    cv2.imwrite('aa.png', im_thresh_color)
...
cap = cv2.VideoCapture("videos/enter_1.mp4")
